              ...
              <div class="row mb-5">
                <div id="table-list-container" class="col-md-12">
                  <!-- Striped Rows -->
                    ...
                    <br />
                    <div class="card" id="ticketListBox">
                    ...
                    <!--/ Striped Rows -->
                    <div id="createBoxContainer" class="col-md-12 col-lg-12">
                      <div class="card d-none" id="createBox">
                        <h5 class="card-header pb-3">Create Ticket</h5>             
                          <div class="card-body">
                            <form id="boxForm" method="POST">
                              <input type="hidden" name="uuid" />
                              <div class="row">
                                <div class="mb-3">
                                  <label for="header" class="form-label">Title <span class="text-danger">*</span></label>
                                  <input
                                    type="text"
                                    class="form-control"
                                    id="header"
                ...
                <div id="viewTicketBoxContainer" class="col-md-12 col-lg-12">
                    <div id="viewTicketBox" class="card mb-4 d-none">
                        <h5 class="card-header"><b>Followup</b><a class="pull-right closeBtn pointer"><i class="bx bx-x me-1"></i></a></h5>
                        Test
                    </div>
                </div>
              </div>            
            ...
            <script type="text/javascript">              
              $(document).ready(function(){     
                ...
                $("#btnCreateTicket").click(function(){
                  $("#createBoxContainer").removeClass("d-none");
                  $("#createBox").removeClass("d-none");
                  $("#ticketListBox").addClass("d-none");
                  $("#btnCreateTicket").addClass("d-none");
                  $("#makePayment").addClass("d-none");
                })
                
                $("#backButton").click(function(){
                  $("#table-list-container").removeClass("d-none");
                  $("#createBox").addClass("d-none");
                  $("#ticketListBox").removeClass("d-none");
