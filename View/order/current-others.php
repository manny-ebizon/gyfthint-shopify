          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="nav-align-top">
                <ul class="nav nav-pills mb-3" role="tablist">
                  <li class="nav-item">
                    <button type="button" id="bloggerOutreachBtn" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-blogger-outreach-service" aria-controls="navs-pills-blogger-outreach-service" aria-selected="false">Blogger Outreach</button>
                  </li>
                  <li class="nav-item">
                    <button type="button" id="otherServicesBtn" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-other-services" aria-controls="navs-pills-other-services" aria-selected="true">Other Services</button>
                  </li>
                </ul>
            ...
            <script type="text/javascript">              
              $(document).ready(function(){                
                function fetchData(service) {
                    ...
                    $.post("/api/fetch-current-orders/",{"service":service,"token":localStorage.getItem("token")},function(data){
                        var result = JSON.parse(data);  
                          $("#other-datatable").show();
                          $("#other-datatable tbody").html("");
                          if (result.status) {
                              $('#other-datatable').DataTable().destroy();
                ...
                $("#other-datatable").on("click",".approvalRequired",function(){
                  var id = $(this).data("id");
                  var $this = this;
                ...
                $("#other-datatable").on("click",".approvedBtn",function(){
                  var id = $(this).data("id");
                  var $this = this;
                  var button_text = $($this).html();
                  $($this).attr("disabled","disabled");
