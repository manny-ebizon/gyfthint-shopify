            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row mb-5">
                  <div id="table-list-container" class="col-md-12">
                    ...
                    <div class="card">
                      <?php if (false): ?>
                        <h5 class="card-header pb-3"><i class='bx bxs-user-account'></i> Merchants</h5>
                      <?php endif ?>
                      ...
                      <table id="datatable" class="table table-striped">
                        ...
                        <tbody class="table-border-bottom-0">                            
                          <?php foreach ($data['merchants'] as $key => $value): ?>
                            <tr>
                              <td><?php echo $value['store_name']; ?></td>
                              <td><?php echo $value['store_email']; ?></td>
                              <td><a href="https://<?php echo $value['myshopify_domain']; ?>" target="_blank"><?php echo $value['myshopify_domain']; ?></a></td>
                              <td><label class="badge bg-label-success" style="color:#fff !important;"><?php if ($value['label']!="") {
                                echo strtoupper($value['label']);
                              } else { echo "FREE"; } ?></label></td>
                            </tr>
                          <?php endforeach ?>
                        </tbody>
                      </table>                  
                  ...
                  <div id="viewBoxContainer" class="col-md-6 col-lg-5">
                    <div id="viewBox" class="card mb-4 d-none">
                        <h5 class="card-header"><b>Add New Client</b><a class="pull-right closeBtn pointer"><i class="bx bx-x me-1"></i></a></h5>
                        <div class="card-body">
              ...
              $(document).ready(function(){                
                function fetchData() {
                  return;
                    ...
                    $.post("/api/fetch-table/",{"t":"clients","token":localStorage.getItem("token")},function(data){
                ...
                if (localStorage.getItem("view-box")!=null) {
                  if (localStorage.getItem("view-box")==1 && $('#box-can-add').val()==1) {
                    ...
                    $("#viewBox .card-header > b").text("Add New Client");
                ...
                $("#datatable").on("click",".openBoxBtn",function(){
                  ...
                  $("#viewBox .card-header > b").text("Update Client Details");
                  $("#viewBox").removeClass("d-none");
                  ...
                  $.post("/api/fetch-data/",{"id":$(this).data("id"),"token":localStorage.getItem("token"),"t":"users"},function(response){
                    ...
                    if (result.status) {
                      ...
                      $("#boxForm input[name=billing_address]").val(result.data.billing_address);                      
                      $("#boxForm select[name=category]").val(result.data.category); 
