              ...
              <div class="row mb-5 d-none">
                  ...
                  <div id="viewBoxContainer" class="col-md-6 col-lg-5">
                    <div id="viewBox" class="card mb-4 d-none">
                        <h5 class="card-header"><b>Add New Module</b><a class="pull-right closeBtn pointer"><i class="bx bx-x me-1"></i></a></h5>
                        <div class="card-body">
                          <form id="boxForm" method="POST">
                            <input type="hidden" name="uuid">
                            <div class="row">
                              <div class="mb-3">
                              <label for="module_name" class="form-label">Name <span class="text-danger">*</span></label>
                              <input
                                type="text"
                                class="form-control"
                                id="module_name"
                            ...
                            <div class="mb-3">
                              <label for="module_description" class="form-label">Description <span class="text-danger">*</span></label>
                              <input
                                type="text"
                                class="form-control"
                            ...
                            <div class="mb-3">
                              <label for="module_icon" class="form-label">Icon <span class="text-danger">*</span>(Kindly use boxicons)</label>
                              <input
                                type="text"
                                class="form-control"
                                id="module_icon"
                            ...
                            <div class="mb-3">
                              <label for="module_nav_link" class="form-label">Navigation Link <span class="text-danger">*</span></label>
                              <input
                                type="text"
                                class="form-control"
                                id="module_nav_link"
                                name="module_nav_link"
            ...
            <script type="text/javascript">              
              $(document).ready(function(){            
                function fetchData() { 
                    ...
                    $.post("/api/fetch-table/",{"t":"modules","token":localStorage.getItem("token")},function(data){
                ...
                if (localStorage.getItem("view-box")!=null) {
                  if (localStorage.getItem("view-box")==1 && $('#box-can-add').val()==1) {
                    ...
                    $("#viewBox .card-header > b").text("Add New Module");
                ...
                $(document).on('click', '.btn-toastr-yes', function() {                  
                  $.post("/api/delete-data",{"token":localStorage.getItem("token"),"t":"modules","id":$("#boxForm input[name=uuid]").val()},function(response){
                ...
                $("#datatable").on("click",".openBoxBtn",function(){
                  ...
                  $("#viewBox .card-header > b").text("Update Module Details");
                  $("#viewBox").removeClass("d-none");
                  ...
                  $.post("/api/fetch-data/",{"id":$(this).data("id"),"token":localStorage.getItem("token"),"t":"modules"},function(response){
                    var result = JSON.parse(response);
                    if (result.status) {
                      $("#boxForm input[name=module_name]").val(result.data.module_name);
                      $("#boxForm input[name=module_description]").val(result.data.module_description);
                      $("#boxForm input[name=module_icon]").val(result.data.module_icon);
                      $("#boxForm input[name=module_nav_link]").val(result.data.module_nav_link);
                ...
                $("#boxForm").submit(function(e){
                  ...
                  $.post("/api/addupdate-data",{"token":localStorage.getItem("token"),"t":"modules","data":$(this).serialize(),"unique_index":"email"},function(response){
