    ...
    <?php include('View/includes/menu-nav.php'); ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row mb-5">
                  <div id="table-list-container" class="col-6">
                    <!-- Striped Rows -->
                    <div class="card">
                      <?php if (false): ?>
                      ...
                      <?php endif ?>
                      <div class="card-body">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nec massa ac ante varius luctus vitae non lorem. Sed viverra vulputate congue. Duis et purus et sapien finibus laoreet. Suspendisse potenti. </p>
                        <form id="suggestedhints" method="POST">
                        <div class="row">
                          <div class="col-12">                                                        
                            <?php if (count($data['suggested_hints'])==0): ?>
                              <?php if ($data['license']['label']=="Free"): ?>
                                  <input style="margin-bottom:12px;" type="text" name="suggested_hints[]" value="" class="form-control" placeholder="PDP Url">
                              <?php elseif ($data['license']['label']=="Pro"): ?>
                                  <input style="margin-bottom:12px;" type="text" name="suggested_hints[]" value="" class="form-control"  placeholder="PDP Url">
                                  <input style="margin-bottom:12px;" type="text" name="suggested_hints[]" value="" class="form-control"  placeholder="PDP Url">
                                  <input style="margin-bottom:12px;" type="text" name="suggested_hints[]" value="" class="form-control" placeholder="PDP Url">
                              <?php endif ?>
